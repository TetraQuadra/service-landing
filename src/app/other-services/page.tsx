        ...
        <>
            <section className="w-full py-16 " id="services">
                <div className="mx-auto container px-2 w-full">
                    <h2 className="text-[64px] max-lg:text-[44px] max-sm:text-[36px] font-[600] text-center mb-12 bg-gradient-to-r from-white via-white to-[#999999] bg-clip-text text-transparent max-sm:text-white">OTHER SERVICES</h2>
